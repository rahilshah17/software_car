...
class CameraGeometry(object):
    ...
    def __init__(self, height=0.055, yaw_deg=0, pitch_deg=0, roll_deg=0, image_width=1920, image_height=1080, field_of_view_deg=45):
    ...
    def precompute_grid(self,dist=1):
