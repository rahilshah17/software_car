...
# _C.DATASET.DATAROOT = "C:\Users\Rahil\Desktop\College\sem6\ramakrishna_sir_project\segmentation\data\bdd100k_images_100k (1)\bdd100k\images\100k"       # the path of images folder
# _C.DATASET.LABELROOT = 'C:\Users\Rahil\Desktop\College\sem6\ramakrishna_sir_project\segmentation\data\det_annotations (1)\data2\zwt\bdd\bdd100k\labels\100k'      # the path of det_annotations folder
# _C.DATASET.MASKROOT = 'C:\Users\Rahil\Desktop\College\sem6\ramakrishna_sir_project\segmentation\data\da_seg_annotations (2)\bdd_seg_gt'                # the path of da_seg_annotations folder
# _C.DATASET.LANEROOT = 'C:\Users\Rahil\Desktop\College\sem6\ramakrishna_sir_project\segmentation\data\ll_seg_annotations (1)\bdd_lane_gt'               # the path of ll_seg_annotations folder
...
# DATASET related params
_C.DATASET = CN(new_allowed=True)
_C.DATASET.DATAROOT = "/segmentation/data/bdd100k_images_100k (1)/bdd100k/images/100k"
_C.DATASET.LABELROOT = "/segmentation/data/det_annotations (1)/data2/zwt/bdd/bdd100k/labels/100k"      # the path of det_annotations folder
_C.DATASET.MASKROOT = "/segmentation/data/da_seg_annotations (2)/bdd_seg_gt"                # the path of da_seg_annotations folder
_C.DATASET.LANEROOT = "/segmentation/data/ll_seg_annotations (1)/bdd_lane_gt"               # the path of ll_seg_annotations folder
_C.DATASET.DATASET = 'BddDataset'
_C.DATASET.TRAIN_SET = 'train'
_C.DATASET.TEST_SET = 'val'
_C.DATASET.DATA_FORMAT = 'jpg'
